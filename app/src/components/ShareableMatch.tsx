  ...
  return (
    <div 
      ...
      style={{ 
        ...
        background: !isPost ? 'linear-gradient(to bottom, #ffffff 0%, #f7f9fb 15%, #f7f9fb 85%, #ffffff 100%)' : undefined
      }}
    >
        ...
        {isPost ? (
            /* Post Layout (Landscape) - MAINTAIN EXISTING REFINED STYLE */
            <>
                <div className={clsx(
                    "absolute transform -rotate-6 z-0 opacity-15 bg-linear-to-bl from-[#005a87] to-[#005a87]",
                    "h-[400px] w-[800px] top-[-100px] right-[-100px]"
                    ...
                    <div className="flex justify-between items-start mb-12">
                        <div>
                            ...
                            <h1 className="font-display font-black text-[#005a87] text-[100px] uppercase tracking-tighter leading-[0.85]">
                                THE<br/><span className="text-[#005a87]">RESULT</span>
                            </h1>
                        </div>
            ...
            /* Story Layout (Portrait) - UPDATED TO MATCH REFERENCE */
