        ...
        {isPost ? (
                ...
                <div className="w-full flex justify-between items-start mb-10 pt-2 px-8">
                    <div className="flex flex-col items-start gap-4">
                        ...
                        <div className="flex items-center gap-4 mt-2">
                             ...
                             <p className="font-stat font-black tracking-[0.4em] text-[#16559a] opacity-60 uppercase text-xs">
                                OFFICIAL STANDINGS
                             </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-end gap-6">
                        <div className="bg-[#ffc72c] text-[#16559a] px-6 py-2 font-display font-black uppercase tracking-widest text-2xl shadow-sm">
                            {division}
                        </div>
                        <p className="font-stat font-black uppercase tracking-[0.4em] text-xl text-[#16559a] opacity-40">
                            PICKLEBALL.KY
                        </p>
                    </div>
                </div>
                ...
                <div className="w-full flex-1 flex flex-col gap-0 px-8">
                    {isSingleColumnPost ? (
                        <div className="max-w-[900px] w-full mx-auto flex flex-col">
                            ...
                            <div className="flex flex-col border border-[#16559a]/5">
            ...
            <div className="flex flex-col justify-start items-center relative z-10 px-8 pt-20 pb-16 flex-1">
                ...
                <div className="text-center space-y-2 mb-10">
                    <h1 className="font-display font-black text-[#16559a] text-[100px] uppercase tracking-tighter leading-[0.75] flex flex-col">
                ...
                <div className="w-full flex flex-col">
                    ...
                    {entries.length > 12 && (
                        <div className="text-center pt-6">
                            <p className="font-display font-black text-[#16559a] opacity-20 uppercase tracking-widest text-2xl">
