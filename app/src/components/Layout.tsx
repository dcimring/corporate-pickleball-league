  ...
  return (
    ...
    >
      ...
      <header className="topbar grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] items-center gap-4 py-4 px-6 md:px-[clamp(20px,4vw,56px)]">
        ...
        <div className="topbar-tabs flex w-full max-w-[380px] mx-auto gap-1 bg-card border border-rule rounded-full p-1.5 shadow-[0_8px_24px_-16px_rgba(20,58,120,0.25)] justify-center overflow-hidden">
          {pageTabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`tab flex-1 py-2.5 font-display font-extrabold text-[12px] sm:text-[13px] tracking-[0.14em] uppercase rounded-full transition-all duration-140 text-center ${
                  isActive 
