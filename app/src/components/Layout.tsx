          ...
          {pageTabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`tab flex-1 md:flex-initial px-0 md:px-7 py-2.5 font-display font-extrabold text-[12px] sm:text-[13px] tracking-[0.14em] uppercase rounded-full transition-all duration-140 text-center ${
                  isActive 
