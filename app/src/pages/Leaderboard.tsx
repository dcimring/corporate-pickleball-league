  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest px-4">Option 1: Neon Pill</p>
        <PageTabs variant="neon-pill" />
        
        {/* Division Toggle Placeholder */}
        <div className="px-4 opacity-50 pointer-events-none grayscale">
           <DivisionTabs divisions={divisions} activeDivision={activeDivision} onChange={handleDivisionChange} />
        </div>
      </div>

      <div className="space-y-4 border-t border-gray-100 pt-8">
        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest px-4">Option 2: Minimal Glow</p>
        <PageTabs variant="minimal-glow" />
        
        {/* Division Toggle - Active for this one */}
      ...
      <div className="space-y-4 border-t border-gray-100 pt-8">
        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest px-4">Option 3: Floating Card</p>
        <PageTabs variant="floating-card" />
        <div className="px-4 opacity-50 pointer-events-none grayscale">
           <DivisionTabs divisions={divisions} activeDivision={activeDivision} onChange={handleDivisionChange} />
        </div>
      </div>
